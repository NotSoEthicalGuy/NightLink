...
import { Upload, Image as ImageIcon, X, Calendar, Save } from 'lucide-react'
    ...
    return (
        <div className="max-w-4xl mx-auto pb-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-4xl font-display font-medium text-white mb-1">Edit Event</h1>
                    <p className="text-zinc-500 font-light">Fine-tune the details of your event</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <div className="relative">
                        ...
                        {uploadingImage ? (
                            <div className="border-2 border-dashed border-gold/30 rounded-[24px] p-12 flex flex-col items-center justify-center bg-gold/5 animate-pulse">
                                ...
                                <p className="font-bold uppercase tracking-widest text-xs text-gold">Updating Asset...</p>
                            </div>
                        ) : imagePreview ? (
                ...
                <div className="bg-zinc-900/40 border border-white/5 p-10 rounded-[32px] shadow-2xl backdrop-blur-md space-y-8">
                    ...
                    <div>
                        ...
                        <input {...register('name', { required: true })} className="bg-zinc-900/50 border border-white/10 rounded-xl px-6 py-4 w-full focus:border-gold/50 focus:ring-1 focus:ring-gold/20 outline-none transition-all text-lg font-medium text-white placeholder-zinc-700" placeholder="e.g. Beirut Summer Jam" />
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input {...register('venueName', { required: true })} className="bg-zinc-900/50 border border-white/10 rounded-xl px-6 py-4 w-full focus:border-gold/50 focus:ring-1 focus:ring-gold/20 outline-none transition-all text-white font-medium placeholder-zinc-700" placeholder="e.g. Skybar Beirut" />
                        </div>
                        <div>
                            <label className="block text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-3">Address</label>
                            <input {...register('venueAddress', { required: true })} className="bg-zinc-900/50 border border-white/10 rounded-xl px-6 py-4 w-full focus:border-gold/50 focus:ring-1 focus:ring-gold/20 outline-none transition-all text-white font-medium placeholder-zinc-700" placeholder="Minet El Hosn, Beirut" />
                        </div>
                    </div>
